...
//    for(int i=10;i<FileD.size();i++)
//    {
//        if(FileD[i] != 0)
//        {
//            FileX.push_back(FileD[i]);
//            FileY.push_back(i);
//        }
//    }
...
//    Data.color_Line = QColor(64,55,0);
    Data.color_Point = "Red";
//    Data.color_Point = QColor(255,0,0);
    Data.color_Frame = QColor(255,255,255);
    List.push_back(Data);
    Data.Clear();
    FileY.clear();
...
//    Data.color_Point = QColor(74,66,104);
    Data.color_Frame = QColor(255,255,255);
    List.push_back(Data);
    Data.Clear();
    FileY.clear();
...
//            FileX.push_back(PickT[i]);
    ...
    Data.Type = cData::Point;
//    Data.color_Line = QColor(255,0,0);
    Data.color_Point = "Grey";
//    Data.color_Point = QColor(30,19,73);
    Data.color_Frame = QColor(255,255,255);
    List.push_back(Data);
    Data.Clear();
    FileY.clear();
...
//    Data.color_Point = QColor(64,55,0);
    Data.color_Frame = QColor(255,255,255);
    List.push_back(Data);
    Data.Clear();
    FileY.clear();
...
//    Data.color_Point = QColor(64,55,0);
    ...
    for(int i=0,m=0;i<BgPickT.size();i++)
    {
        if(BgPickT[i] != 0)
        {
//            m=i;
...
//                    if(FileD[j]!=0)
//                    {
////                        FileX.push_back(FileD[j]);
//                        FileX.push_back(mas[j]);
//                        m=j;
//                    }
//                }
//            }
...
//            FileX.push_back(FileD[i]);
    ...
    Data.Array_Y = mas;
    Data.Type = cData::Line;
    Data.color_Line = QColor(215,227,230);
    Data.color_Point = QColor(110,198,219);
    Data.color_Frame = QColor(110,198,219);
    List.push_back(Data);
    Data.Clear();
...
//    Data.Array_Y = mas;
//    Data.Type = cData::Line;
//    Data.color_Line = QColor(65,0,0);
//    Data.color_Point = QColor(65,65,0);
//    Data.color_Frame = QColor(65,65,65);
//    List.push_back(Data);
//    Data.Clear();
